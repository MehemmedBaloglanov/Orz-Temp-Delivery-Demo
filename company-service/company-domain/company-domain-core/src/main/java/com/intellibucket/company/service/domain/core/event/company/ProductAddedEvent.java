...
public class ProductAddedEvent extends CompanyEvent {

    private final ProductRoot productRoot;

    public ProductAddedEvent(CompanyRoot companyRoot, OffsetDateTime createdTime, ProductRoot productRoot) {
