...
//
//    @Override
//    public CompanySuspendedEvent disableCompany(CompanyRoot companyRoot) throws ValidateException {
//        companyRoot.suspend();
//        return new CompanySuspendedEvent(companyRoot,OffsetDateTime.now());
//    }
//
//    @Override
