...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public PaymentRequestAvroModel(java.util.UUID customerId, java.util.UUID orderId, java.math.BigDecimal price, java.time.Instant createdAt) {
   ...
   */
  public static com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder newBuilder() {
    return new com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder();
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder newBuilder(com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder other) {
    if (other == null) {
      return new com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder();
    } else {
      return new com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder newBuilder(com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel other) {
    if (other == null) {
      return new com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder();
    } else {
      return new com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.customerId)) {
        this.customerId = data().deepCopy(fields()[0].schema(), other.customerId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder setCustomerId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder setOrderId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.intellibucket.kafka.order.avro.model.payment.PaymentRequestAvroModel.Builder clearCreatedAt() {
