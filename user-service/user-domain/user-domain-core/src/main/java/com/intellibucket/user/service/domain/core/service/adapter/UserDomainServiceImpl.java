...
public class UserDomainServiceImpl implements UserDomainService {
    ...
    public UserRegisteredEvent companyRegistered(UserRoot userRoot) {
        ...
        return new UserRegisteredEvent(userRoot, OffsetDateTime.now(ZONE_ID));
    }
    ...
    public UserDeletedDomainEvent userDeleted(UserRoot userRoot) {
        userRoot.delete();
        return new UserDeletedDomainEvent(userRoot, OffsetDateTime.now(ZONE_ID));
    }


    @Override
    public UserChangePasswordDomainEvent userChangePassword(UserRoot userRoot) throws UserDomainException {
        return new UserChangePasswordDomainEvent(userRoot, OffsetDateTime.now(ZONE_ID));
    }
    ...
    public UserLoggedInDomainEvent userLoggedIn(UserRoot userRoot) throws UserDomainException {
        ...
        return new UserLoggedInDomainEvent(userRoot, OffsetDateTime.now(ZONE_ID));
    ...
    public UserUpdatedDomainEvent userUpdated(UserRoot userRoot) {
        userRoot.update();
    return new UserUpdatedDomainEvent(userRoot, OffsetDateTime.now(ZONE_ID));
    }
}