...
public interface UserCommandServicePort {
    ...
    void customerUpdate(CustomerUpdateCommand command) throws UserNotFoundException, UserSavedException;

    void companyUpdate(CompanyUpdateCommand command) throws UserNotFoundException, UserSavedException;
